                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarLayouts">
                        ...
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ url('/admins') }}" class="nav-link" data-key="t-order">Admins Panel</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="{{ url('admin/subcategories') }}" class="nav-link" data-key="t-order">Sub
                                    Category</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('admin/products') }}" class="nav-link" data-key="t-product">Products</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('admin/orders') }}" class="nav-link" data-key="t-order">Orders</a>
                            </li>
                            <li class="nav-item">
